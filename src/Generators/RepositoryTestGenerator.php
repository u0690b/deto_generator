...
class RepositoryTestGenerator extends BaseGenerator
{
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = config('deto.laravel_generator.path.repository_test', base_path('tests/Repositories/'));
        $this->fileName = $this->commandData->modelName.'RepositoryTest.php';
    }

    public function generate()
    {
        $templateData = get_template('test.repository_test', 'deto_generator');
