...
namespace Deto\Generator\Commands;

use Deto\Generator\Common\CommandData;
use Deto\Generator\Generators\API\APIControllerGenerator;
use Deto\Generator\Generators\API\APIRequestGenerator;
use Deto\Generator\Generators\API\APIResourceGenerator;
use Deto\Generator\Generators\API\APIRoutesGenerator;
use Deto\Generator\Generators\API\APITestGenerator;
use Deto\Generator\Generators\FactoryGenerator;
use Deto\Generator\Generators\MigrationGenerator;
use Deto\Generator\Generators\ModelGenerator;
use Deto\Generator\Generators\RepositoryGenerator;
use Deto\Generator\Generators\RepositoryTestGenerator;
use Deto\Generator\Generators\Scaffold\ControllerGenerator;
use Deto\Generator\Generators\Scaffold\JQueryDatatableAssetsGenerator;
use Deto\Generator\Generators\Scaffold\MenuGenerator;
use Deto\Generator\Generators\Scaffold\RequestGenerator;
use Deto\Generator\Generators\Scaffold\RoutesGenerator;
use Deto\Generator\Generators\Scaffold\ViewGenerator;
use Deto\Generator\Generators\SeederGenerator;
...
class BaseCommand extends Command
{
    ...
    {
        $migrationPath = config('deto.laravel_generator.path.migration', database_path('migrations/'));
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('deto.laravel_generator.path.schema_files', resource_path('model_schemas/'));
    ...
    private function saveLocaleFile()
    {
        ...
        $path = config('deto.laravel_generator.path.models_locale_files', base_path('resources/lang/en/models/'));
