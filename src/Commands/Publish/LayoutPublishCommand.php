...
class LayoutPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'deto.publish:layout';
    ...
    {
        $templateData = get_template('home_controller', 'deto_generator');
    ...
    private function fillTemplate($templateData)
    {
        $templateData = str_replace(
            ...
            config('deto.laravel_generator.namespace.controller'),
            $templateData
        );

        $templateData = str_replace(
            '$NAMESPACE_REQUEST$',
            config('deto.laravel_generator.namespace.request'),
            $templateData
        );
