...
class HTMLFieldGenerator
{
    ...
    public static function generateImport(GeneratorField $field)
    {
        $fieldTemplate = '';
    ...
    public static function generateComponents(GeneratorField $field)
    {
        $fieldTemplate = '';

        if (Str::endsWith($field->name, '_id')) {
            $fieldTemplate = "MySelect";
        } else {
            switch ($field->htmlType) {
                case 'text':
                case 'date':
                ...
                case 'select':
                case 'enum':
                    $fieldTemplate = "SelectInput";
                    break;
                case 'toggle-switch':
                    $fieldTemplate = "ToggleInput";
                    break;
            }
        }
